...
class Users extends amplify_core.Model {
  ...
  const Users._internal({required this.id, required userName, required userIdentity, required commentsID, createdAt, updatedAt}): _userName = userName, _userIdentity = userIdentity, _commentsID = commentsID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Users({String? id, required String userName, required String userIdentity, required String commentsID}) {
  ...
  String toString() {
    ...
    buffer.write("commentsID=" + "$_commentsID" + ", ");
  ...
  Users copyWith({String? userName, String? userIdentity, String? commentsID}) {
    return Users._internal(
      id: id,
  ...
  Users copyWithModelFieldValues({
    ...
    ModelFieldValue<String>? commentsID
  }) {
    return Users._internal(
      id: id,
      userName: userName == null ? this.userName : userName.value,
      userIdentity: userIdentity == null ? this.userIdentity : userIdentity.value,
      commentsID: commentsID == null ? this.commentsID : commentsID.value
    );
  }
  ...
  Users.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _commentsID = json['commentsID'],
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'userName': _userName, 'userIdentity': _userIdentity, 'commentsID': _commentsID, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final COMMENTSID = amplify_core.QueryField(fieldName: "commentsID");
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      amplify_core.ModelIndex(fields: const ["commentsID"], name: "byComments")
    ];
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: Users.USERIDENTITY,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: Users.COMMENTSID,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
